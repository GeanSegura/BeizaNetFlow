...
<head>
    ...
    <link rel="stylesheet" href="./CSS/RegistrarseStyle.css?v={{ time() }}">
</head>
<body>
...
<section class="vh-80" style="background-color: #121212;">
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form class="mx-1 mx-md-4" id="registrationForm" method="POST">
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                <img src="./img/Fondo2025.png" class="img-fluid" alt="Sample image">
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="./scripts/registrarUsuario.js?v={{ time() }}"></script>
